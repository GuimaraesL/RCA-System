    ...
    <div className="p-8 max-w-5xl mx-auto animate-in fade-in space-y-8 pb-20">
      <div className="flex items-center gap-3 border-b border-slate-200 pb-6">
        ...
        <div>
            ...
            <p className="text-slate-500">Sistema Global RCA • Versão Integrada (Context API + Gemini 2.5)</p>
        </div>
      </div>
      ...
      <section className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-center gap-2 mb-4 border-b border-slate-100 pb-2">
            ...
            <h2 className="text-xl font-bold text-slate-800">1. Arquitetura de Dados</h2>
        </div>
      ...
      <section className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-center gap-2 mb-4 border-b border-slate-100 pb-2">
            ...
            <h2 className="text-xl font-bold text-slate-800">2. Workflow e Regras de Negócio</h2>
        </div>
      ...
      <section className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm transition-all hover:shadow-md">
        <div className="flex items-center gap-2 mb-4 border-b border-slate-100 pb-2">
            ...
            <h2 className="text-xl font-bold text-slate-800">3. Integrações e Migração</h2>
        </div>
