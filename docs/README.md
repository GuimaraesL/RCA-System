...
- [Estrutura de Dados (IA)](./ai/data_architecture.md) - Base de conhecimento e bancos vetoriais (/data).
...
- [Pipeline de RAG](./ai/rag_pipeline.md) - Fluxo de busca vetorial e injeção de contexto via ChromaDB.
